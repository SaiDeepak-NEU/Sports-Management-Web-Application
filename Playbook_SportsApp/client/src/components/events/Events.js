...
const sportList = ["All Sports", "Badminton", "Tennis", "Volleyball", "Basketball", "Cricket", "Running", "Table tennis", "Football", "Soccer"];
            ...
            <div className="minHeight">
                <Grid container className="marginX-1">
                    <Grid item xs={12} sm={6} md={6}>
                        <Typography className="primary-textColor marginT-2" variant="h3" component="h3">
                            List of Events
                        </Typography>
                    </Grid>
                    <Grid item xs={12} sm={6} md={6}>
